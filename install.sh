...
sudo apt install python3-flask python3-eventlet python3-selenium python3-yaml python3-waitress python3-soundfile python3-pygame chromium-browser chromium-chromedriver libportaudio2 git-lfs -y
